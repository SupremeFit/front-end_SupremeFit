...
function updateCartDisplay() {
  ...
  cart.forEach(item => {
    ...
    cartItemElement.innerHTML = `
      <img class="image-product-cart" src="${item.imageUrl}" alt="${item.altText}" />
...
const cardsProducts = () => {
  const ulElement = document.querySelector('.list-all-products');
  ulElement.innerHTML = '';
  ...
  products.forEach(product => {
    ...
    liElement.innerHTML = `
      <img class="image-product" src="${product.imageUrl}" alt="${product.altText}" />
      <div class="container-description">
